...
class RagAgent:
    ...
    def _answer(
        ...
        instructions = (
            ...
            "Use simple, standard Markdown only. Format links exactly as [descriptive label](https://...) "
            "and images exactly as ![descriptive alt text](https://...); put each image on its own line. "
            "Do not nest Markdown links, bold the URL or link syntax, wrap a link or image in bold "
            "markers or decorative parentheses, or show a raw URL as the link label. Never output "
            "Source citations, internal document links, private profile "
